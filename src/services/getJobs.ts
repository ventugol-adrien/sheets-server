import { ashbyJob, dennemeyerJob, everstoxJob, frankaRoboticsJob, konuxJob, openAIJob, personioJob_1,personioJob_2, shapeInJob, understandRecruitmentJob } from "../assets/jobs"
